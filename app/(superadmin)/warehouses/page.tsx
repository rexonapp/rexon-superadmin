...
<div className="flex flex-col gap-3 p-3 sm:p-0 h-full">
      ...
      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden flex flex-col min-h-0 flex-1">
          ...
          <Table className="min-w-[900px]">
            <TableHeader className="sticky top-0 z-10">
              <TableRow className="bg-gray-50 hover:bg-gray-50 border-b border-gray-200">
                ...
                <TableHead className="text-[11px] font-bold uppercase tracking-[0.07em] text-gray-400 h-11 px-4 text-right bg-gray-50 w-16">
                  Actions
                </TableHead>
              </TableRow>
            </TableHeader>
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button variant="ghost" size="icon"
                          className="h-7 w-7 opacity-40 group-hover:opacity-100 transition-opacity hover:bg-gray-100">
                          <MoreVertical className="w-4 h-4" />
                        </Button>
                      </DropdownMenuTrigger>
                      <DropdownMenuContent align="end" className="w-44">
                        <DropdownMenuItem onClick={() => openDetails(w)} className="cursor-pointer text-[13px] py-2">
                          <Eye className="w-4 h-4 mr-2 text-blue-500" /> View Details
                        </DropdownMenuItem>
                        {w.status === 'Pending' && (<>
                          <DropdownMenuItem onClick={() => updateStatus(w.id, 'Active')}
                            className="cursor-pointer text-[13px] py-2 text-emerald-600 focus:bg-emerald-50">
                            <CheckCircle className="w-4 h-4 mr-2" /> Approve
                          </DropdownMenuItem>
                          <DropdownMenuItem onClick={() => updateStatus(w.id, 'rejected')}
                            className="cursor-pointer text-[13px] py-2 text-rose-600 focus:bg-rose-50">
                ...
                <TableRow>
                  <TableCell colSpan={10} className="text-center py-20">
                    <div className="flex flex-col items-center gap-3 text-gray-400">
                      ...
                      <p className="font-semibold text-[14px] text-gray-500">No warehouses found</p>
        ...
        {sorted.length > ITEMS_PER_PAGE && (
          <div className="border-t border-gray-100 px-4 py-3 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 bg-white flex-shrink-0">
